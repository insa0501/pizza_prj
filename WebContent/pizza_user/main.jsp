...
<%--                         <span>
                         ...
                         <div class="[ form-group ]"> 
                            <input type="checkbox" name="selectmenu" value="${menu_pizza.menu_name}/${menu_pizza.menu_price}" id="fancy-checkbox-danger-custom-icons pizza${status.index}"/>
                            <div class="[ btn-group ]">
...
<%--                         <span>
                         ...
                         <div class="[ form-group ]"> 
                            <input type="checkbox" name="selectside" value="${menu_side.menu_name}/${menu_side.menu_price}" id="fancy-checkbox-danger-custom-icons side${status.index}"/>
                            <div class="[ btn-group ]">
